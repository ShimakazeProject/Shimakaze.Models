...
namespace Shimakaze.Models.Csf
{
    ...
    public struct CsfHead : IEquatable<CsfHead>
    {
        ...
        public override bool Equals(object? obj) => obj is CsfHead head && Equals(head);
        ...
        public override int GetHashCode() => HashCode.Combine(version, labelCount, stringCount, unknown, language);

        public override string ToString() => $"Version = {Version}, LabelCount = {LabelCount}, StringCount = {StringCount}, Unknown = {Unknown}, Language = {Language}";

        public static bool operator ==(CsfHead left, CsfHead right) => left.Equals(right);

        public static bool operator !=(CsfHead left, CsfHead right) => !(left == right);
    }
}